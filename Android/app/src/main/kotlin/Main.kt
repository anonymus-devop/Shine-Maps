...
internal val logger: SkipLogger = SkipLogger(subsystem = "horizon.maps", category = "HorizonMaps")

private typealias AppRootView = HorizonMapsRootView
private typealias AppDelegate = HorizonMapsAppDelegate
